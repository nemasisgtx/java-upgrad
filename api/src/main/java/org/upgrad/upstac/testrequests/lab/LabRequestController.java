...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        TestRequest loggedindoc = new TestRequest();
        User loggedInUser = userLoggedInService.getLoggedInUser(loggedindoc);
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        User tester =userLoggedInService.getLoggedInUser(loggedindoc);
